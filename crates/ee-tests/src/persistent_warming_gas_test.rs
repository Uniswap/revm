...
use revm::{
    ...
    interpreter::gas::{COLD_ACCOUNT_ACCESS_COST, COLD_SLOAD_COST, WARM_STORAGE_READ_COST},
...
fn test_persistent_warming_account_access_gas() {
    ...
    // Test WITH persistent warming
    {
        ...
        println!(
            "Expected:   {} gas (COLD_ACCOUNT_ACCESS_COST - WARM_STORAGE_READ_COST)",
            expected_savings
        );
        ...
        assert!(
            ...
            "Expected {} gas savings (COLD_ACCOUNT_ACCESS_COST - WARM_STORAGE_READ_COST), got {}",
            expected_savings,
            gas_saved
        );
    }
...
fn test_persistent_warming_storage_access_gas() {
    ...
    // Test WITH persistent warming
    {
        ...
        let gas_saved = gas1 - gas2;
        let expected_savings = COLD_SLOAD_COST - WARM_STORAGE_READ_COST;
        ...
        println!("Saved:      {} gas", gas_saved);
        println!(
            "Expected:   {} gas (COLD_SLOAD_COST - WARM_STORAGE_READ_COST)",
            expected_savings
        );
        ...
        assert!(
            gas_saved == expected_savings,
            "Expected {} gas savings (COLD_SLOAD_COST - WARM_STORAGE_READ_COST), got {}",
            expected_savings,
            gas_saved
        );
    }
...
fn test_persistent_warming_combined_gas() {
    ...
    let gas_saved = gas1 - gas2;
    let expected_savings = COLD_ACCOUNT_ACCESS_COST - WARM_STORAGE_READ_COST + COLD_SLOAD_COST - WARM_STORAGE_READ_COST;
    ...
    println!(
        "Expected:                           {} gas (COLD_ACCOUNT_ACCESS_COST - WARM_STORAGE_READ_COST + COLD_SLOAD_COST - WARM_STORAGE_READ_COST)",
        expected_savings
    );
